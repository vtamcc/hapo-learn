            ...
            <div class="card-col col-lg-4">
                <div class="card-main card">
                    <div class="card-image card-center">
                        <img src="{{ asset('images/laravel-1-logo-black-and-white 1.png') }}" class="card-img-top" alt="" >
                    </div>
                        <div class="card-body">
            ...
            <div class="card-col col-lg-4">
                <div class="card-main card">
                    <div class="card-image card-right">
                        <img src="{{asset('images/Rectangle 15.png')}}" class="card-img-top" alt="" >
                    </div>
                    <div class="card-body">
            ...
            <div class="card-col col-lg-4">
                <div class="card-main card">
                    <div class="card-image card-right other-right">
                        <img src="{{asset('images/java 1.png')}}" class="card-img-top" alt="" >
                    </div>
                    <div class="card-body">
